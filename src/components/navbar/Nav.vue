        ...
        <nav v-if="$route.name != 'Landing'" class="navbar modimo-navbar">
            ...
            <div class="navbar-brand">
                <a class="navbar-item" href="/home">
                    ...
                    <span class="is-hidden-touch" style="color: #2b5bb2">&nbsp;{{($parent.currentUser && $parent.currentUser.name ? $parent.currentUser.name.substr(0, $parent.currentUser.name.search(' ')) : "")}}</span>
                </a>
