module.exports = [
  ...
  },
  {
    'messages': [
      {
        'self': false,
        'content': "Je n'ai plus de clef depuis deja plus de 2 semnaines!! J'ai tenté de vous appeler, de vous envoyer des messages, je ne peux plus rentrer une fois la porte fermée..."
      },
      {
        'self': true,
  ...
  },
  {
    ...
    'messages': [
      {
        'self': false,
        'content': 'Bienvenue dans la messagerie!\nJe suis le précédent gardien de cette résidence, et je suis disponible en cas de nécessité. Vous pouvez me contacter a tout moment via ce système de messagerie instantanée.\n'
      },
      {
        'self': false,
      ...
      {
        'self': true,
        'content': "Bonjour,\nJe ne suis pas encore familiarisé avec cette Magnifique plateforme, laissez moi le temps de la découvrir et je résoudrais cette affaire."
      },
      {
        'self': false,
        'content': "À la bonne heure! Que l'aventure commence, bon courage!!!"
      },
      {
        'self': true,
